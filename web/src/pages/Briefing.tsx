    ...
    <div style={{ background: COLORS.cream, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "52px 24px" }}>
        ...
        <h2 style={{
          ...
          District 3 urban intelligence, powered by live DataSF data.
        </h2>
          ...
          {stats.map(s => (
            <div key={s.label} style={{ background: s.bg, borderRadius: 16, padding: "26px 22px" }}>
              ...
              <div style={{
                ...
                marginTop: 6, fontFamily: FONTS.body, fontWeight: 500,
              }}>{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          color: COLORS.charcoal, boxShadow: "0 2px 12px rgba(0,0,0,0.03)",
        }}>
          {sections.briefing ? (
