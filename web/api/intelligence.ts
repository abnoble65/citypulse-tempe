 ...
 *
 * Self-contained: all data-fetching and package generation logic is inlined
 * so Vercel can compile this as a single serverless function with no local imports.
 *
...
async function generateIntelligencePackage(
  apn: string,
